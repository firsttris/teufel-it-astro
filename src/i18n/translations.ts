...
export const ui = {
    en: {
        ...
        "subtitle": "Expert in Clean-Code, Test Automation and Test-Driven Development (TDD).",
    ...
    de: {
        ...
        "subtitle": "Experte für Clean-Code, Testautomatisierung und Testgetriebene Entwicklung (TDD).",

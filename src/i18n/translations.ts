...
export const ui = {
    en: {
        ...
        "subtitle": "I am an expert in Clean-Code, Test Automation and Test-Driven Development (TDD).",
    ...
    de: {
        ...
        "subtitle": "Ich bin Experte für Clean-Code, Testautomatisierung und Testgetriebene Entwicklung (TDD).",
